...
This system uses an acceleration sensor to continuously monitor vehicle motion. 

When a sudden impact or abnormal acceleration is detected beyond a predefined threshold, the system identifies it as a potential accident.
